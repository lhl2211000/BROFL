...
### Description
This repository include implementations for a variety of established Federated Learning methods as well as two novel methods, FedCVAE-KD and FedCVAE-Ens. 
### Prerequisites
1. Python 3.9.x+
2. `pip`
...
Run the following from command line.
```
python main.py --algorithm fedavg --dataset mnist --num_users 10 --alpha 0.5 --sample_ratio 0.5 --glob_epochs 1 --local_epochs 10 --should_log 1 --use_adam 1
```
...
Run the following from command line. 
```
python main.py --algorithm fedcvaeens --dataset mnist --num_users 10 --alpha 0.001 --sample_ratio 0.5 --local_epochs 15 --should_log 1 --z_dim 10 --beta 1.0 --classifier_num_train_samples 1000 --classifier_epochs 10 --uniform_range "(-1.0, 1.0)" --use_adam 1       
```
